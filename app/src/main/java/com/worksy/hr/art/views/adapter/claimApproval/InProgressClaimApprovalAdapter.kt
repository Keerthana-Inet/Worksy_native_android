...
class InProgressClaimApprovalAdapter(
    val context: Context,
...
) : RecyclerView.Adapter<InProgressClaimApprovalAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.approvalListRecyclerview.setOnClickListener {
